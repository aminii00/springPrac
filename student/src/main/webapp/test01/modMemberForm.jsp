...
<form method ="post" action ="${contextPath}/member153/modMember.do?id=${memInfo.username}">
<table align ="center">
  <tr>
  ...
  <tr>
    ...
    <td width="400"><input type ="text" name ="pwd" value = "${memInfo.univ }"></td>
  </tr>
  <tr>
    <td width="200"><p align ="right">생년월일</td>
    <td width="400"><input type ="text" name ="name" value = "${memInfo.birth }"></td>
  </tr>
  <tr>
