...
<body>
<form name = "form" method ="post" action ="${contextPath}/member153/addMember.do">
<h1 style ="text-align:center">학생등록창</h1>
<table align ="center">
  <tr>
  ...
  <tr>
    ...
    <td width="400"><input type ="text" name ="univ"></td>
  </tr>
  <tr>
    <td width="200"><p align ="right">생년월일</td>
    <td width="400"><input type ="text" name ="birth" ></td>
  </tr>
  <tr>
